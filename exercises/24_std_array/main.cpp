...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        ASSERT(arr.size() == sizeof(arr)/sizeof(double), "Fill in the correct value.");
        ASSERT(sizeof(arr) == sizeof(arr), "Fill in the correct value.");
    }
    {
        std::array<char, 21> arr{"Hello, InfiniTensor!"};
        ASSERT(arr.size() == arr.size(), "Fill in the correct value.");
        ASSERT(sizeof(arr) == sizeof(arr), "Fill in the correct value.");
